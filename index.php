    ...
    <article id="webslides" class="vertical container">
      ...
      <section class="aligncenter">
        <div class="wrap">
          ...
          <p class="text-intro my-3">Our dedicated team of experienced web developers create custom online solutions. Whether it is enhancing an existing application or architecting an enterprise application, our developers are up for your challenge</p>
          <p>
      ...
      <section class="slide-bottom">
        <div class="wrap">
          <div class="content-right text-serif">
            ...
            <p>People share content that makes them feel inspired. WebSlides is a very effective way to engage young
              audiences, customers, and teams.</p>
            <p>Best,<br> <a href="https://twitter.com/jlantunez">@jlantunez</a>, <a
