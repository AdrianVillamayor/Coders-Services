...
find ../ -name '*.php' | xargs xgettext --from-code UTF-8 -L php -p ../locale/es_ES/LC_MESSAGES/ --default-domain=metalast
fi
...
find ../ -name '*.php' | xargs xgettext --from-code UTF-8 -L php -p ../locale/ca_ES/LC_MESSAGES/ -o update.po --copyright-holder metalast
msgmerge -U ../locale/ca_ES/LC_MESSAGES/metalast.po ../locale/ca_ES/LC_MESSAGES/update.po
rm ../locale/ca_ES/LC_MESSAGES/update.po
else
find  ../  -name '*.php' | xargs xgettext --from-code UTF-8 -L php -p ../locale/ca_ES/LC_MESSAGES/ --default-domain=metalast
fi
...
find  ../  -name '*.php' | xargs xgettext --from-code UTF-8 -L php -p ../locale/en_US/LC_MESSAGES/ --default-domain=metalast
fi
